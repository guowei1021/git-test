...
<body data-type="generalComponents">
	...
	$(function(){
		...
		var arr = [
			...
			},
			{
				...
				"render" : function(data, type, row) {
					//console.log(row)
					var buttonHtml = "";
					buttonHtml += '<button  class="details table_btn look_score" onclick="paper_detail(\'' + row.answer_paper_id + '\')" value="查看详情" style="float:left;margin-right:5px;margin-left:5px;"></button>';
					return buttonHtml;
				}
			}
		];
		var page = "pli"; //p代表页码   l 代表  每页显示多少条  i  代表 一共多少条，当前多少条	
		var url = "/exam/api/examHistory?method=getlist";
		var apply = {
			exam_name : "",
			exam_type : ""
		};
		...
		//查看详情按钮
		function paper_detail(answer_paper_id){
			//alert(answer_paper_id)
			window.location.href = "../examinee/exam-score.jsp";
		}
