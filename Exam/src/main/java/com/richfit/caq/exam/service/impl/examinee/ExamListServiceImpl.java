...
@DOL
@Service("examListDOL")
public class ExamListServiceImpl implements DataOperater {
	Logger logger = LoggerFactory.getLogger(ExamListServiceImpl.class);
	@Autowired
	private BaseDao baseDao;
	
	private String namespace = "com.richfit.caq.exam.service.impl.examinee.examList";
	@Override
